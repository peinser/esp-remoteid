...
static const led_pattern_step_t s_solid[] = {
    { true, 1000 },
};

static const led_pattern_step_t s_beacon_1hz_short[] = {
    { true, 100 },
    { false, 900 },
};

static const led_pattern_step_t s_beacon_1hz_50[] = {
    { true, 500 },
    { false, 500 },
};

static const led_pattern_step_t s_strobe_single[] = {
    { true, 60 },
    { false, 1940 },
};

static const led_pattern_step_t s_strobe_double[] = {
    { true, 60 },
    { false, 80 },
    { true, 60 },
    { false, 1800 },
...
static const led_pattern_step_t s_strobe_triple[] = {
    { true, 60 },
    { false, 80 },
    { true, 60 },
    { false, 80 },
...
static const led_pattern_step_t s_fast_strobe[] = {
    { true, 60 },
    { false, 440 },
};
...
{
    size_t count = 0;
    const led_pattern_step_t *steps = led_pattern_steps(pattern, &count);
